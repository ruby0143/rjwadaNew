  ...
  return (
    <div className="privacy-section">
      <div className="privacy-main-heading-text">
        ...
        <p>
          Your Privacy is important to us at Rjwada.We respect your privacy
          regarding any information wecollect from you from across our website.
        </p>
        <p>
          This privacy notice for Rjwada Private Limited (doing business as
          Rjwada) ('Rjwada', 'we', 'us', or 'our',), describes how and why we
          might collect, store, use, and/or share ('process') your information
          when you use our services ('Services'). We know that You (a visitor or
          a registered user) care how information about You is used and shared,
          and we appreciate Your trust that we will do so carefully and
          sensibly. We let You retain as much control as possible over Your
          personal information. However, you may not visit and use our site at
          any time without telling us who You are or revealing the required
          information about Yourself. To the Company, our most important asset
          is our relationship with You. We are committed to maintaining the
          confidentiality, integrity and security of any personal information
          about our users of our site. We are proud of our privacy practices and
          the strength of our site security and want you to know how we protect
          Your information and use it to provide to You the services. This
          notice describes our privacy policy. By visiting this Website, You are
          accepting the practices described in this Privacy Policy. You further
          agree and consent to our collection, use, processing, disclosure and
          transfer of your personal data according to the provisions of this
          Privacy Policy{" "}
        </p>
      </div>
      <div className="privacy-heading-text">
        ...
        <p>
          ...
          we collect may include but not restricted to names, phone numbers,
          email addresses, mailing addresses, billing addresses, contact or
          authentication data, usernames, debit/credit card numbers
        </p>
        ...
        <p>
          ...
          find their privacy notice link(s) here: https://razorpay.com/privacy/.
        </p>
        ...
        <p>
          ...
          access or permissions, you may do so in your device's settings. <br />
        ...
        <p>
          Information automatically collected: We automatically collect certain
        ...
        <p>
          The information we collect includes Location Data. We collect location
      ...
      <div className="privacy-heading-text">
        ...
        <p>
          ...
          your interests, location, and more, may process your information when
      ...
      <div className="privacy-heading-text">
        ...
        <p>
          When you submit (or grant us permission to take) a photo, facial/body
          scan, or other image of you, we don’t share those photos, scans, or
          images, or any data captured in the body scans, with any third
          parties, but we may use them to measure your chest width and upper
          body length, to map and measure your body features, to address certain
          problems or concerns you may have with your t shirts, to help better
          understand how our clothing fit our customers and provide
          recommendations. Business Transfers: As we continue to develop our
          business, we might be acquired completely or merge with any other
          company. In such transactions, customer information generally is one
          of the transferred business assets. In such a case, we will ensure the
          protection of Your information as per these policies and guidelines.
          You hereby specifically consent and grant permission to the
          disclosure, and transferring, of information to such third parties.
        </p>
        ...
        <p>
          ...
          with law; to enforce or apply our Terms and Conditions and other
          ...
          companies and organizations for fraud protection and other similar
          matters. You hereby specifically consent and grant permission to
          disclosure and transferring of information to such third parties, as
          maybe required.
        </p>
      </div>
      <div className="privacy-heading-text">
        ...
        <p>
          ...
          interactive experience and generally improve our services to You. You
          can change Your cookie settings to accept or not accept cookies in
          Your browser settings. If You do accept a "cookie", You thereby agree
          to our use of any personal information collected by us using that
          cookie. If You do accept a "cookie", You thereby agree to our use of
          any personal information collected by us using that cookie. Whenever
          we uses a third party to host and serve content, we may arrange for a
          common identifier to be shared between the third party and us in order
          to enable accurate measurement of traffic and usage. <br />
      ...
      <div className="privacy-heading-text">
        ...
        <p>
          ...
          is possible. <br />
          Keeping your data safe: We have implemented appropriate and reasonable
      ...
      <div className="privacy-heading-text">
        ...
        <p>Rjwada Private Limited Confidential __________ __________</p>
        <p>
